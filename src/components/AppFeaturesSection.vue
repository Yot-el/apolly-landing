...
import SectionLayout from '@/components/SectionLayout.vue'
  import gsap from 'gsap'
	...
	onMounted(() => {
      ...
      .from(['.features__item--features', '.features__item--version'], {opacity: 0, y: -10, duration: 0.4})
      .from(['.features__item--design', '.features__item--retina'], {opacity: 0, y: -10, duration: 0.4})
    ...
    <template #content>
      <div class="features container">
        <div class="features__item features__item--chat">
          ...
          <p class="features__description">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </div>
        ...
        <img class="features__image" src="@/assets/images/features.png" alt="mobile interface image"/>
